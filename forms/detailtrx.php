    ...
    <div class="row">
        <div class="col-lg-6 details">
            <div class="panel panel-default my-bg-grey">
                <div class="panel-body">
                    ...
                    <p class="p-elps my-no-margin-topdown"><b>Tujuan Transaksi: </b> <?php
                        if ($row['ismitrabinaan'] == '1') {
                            echo 'Mitra Binaan';
                        } else {
                            echo 'Bina Lingkungan';
                        }
                        ?></p>
                    <p class="p-elps my-no-margin-topdown"><b>Kategori Transaksi: </b> <?php
                        $catid = $row['catid'];
                        $queryselectcat = "select catnama from trxkategory where catid = $catid";
                        $res = mysqli_query($connection, $queryselectcat);
                        $rowcats = $res->fetch_assoc();
                        echo $rowcats['catnama'];
                        ?></p>
                        <?php
                    if ($row['ismitrabinaan'] == '1') {
                        ?><p class="p-elps my-no-margin-topdown"><b>Jumlah Penarikan: </b> Rp. <?php echo $row['pinjaman']; ?></p>
                        ...
                        <p class="p-elps my-no-margin-topdown"><b>Jumlah Angsuran Perbulan: </b> Rp. <?php echo $row['angsuran']; ?></p><?php
                    }
                    ?>
        ...
        <div class="col-lg-6 details">
            <div class="panel panel-default my-bg-grey">
                <div class="panel-body">
                    <h4>Operasi :</h4>
                    <form action="core/pdfcore/examples/generated.php" method="POST" target="_blank">
