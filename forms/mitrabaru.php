        ...
        <div>
            ...
            <div class="form-horizontal">
                <form id="foo">
                    ...
                    <div class="col-sm-6">
                        <button id='submitsaja' class='btn btn-primary' style="float: right !important;">Selesai</button>
                    </div>


                    <div class="col-sm-6">
                        <div class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Selesai & Lanjutkan
                                <span class="caret"></span></button>
                            <ul class="dropdown-menu">
                                <li><button id="exists1" class="btn btn-link" href="#">Mitra Binaan</button></li>
                                <li><button id="exists2" class="btn btn-link" href="#">Bina Lingkungan</button></li>
                            </ul>
                        </div>
                    </div>
...
<script>
    ...
    $("#exists1").click(function (event) {
        ...
        request.done(function (response, textStatus, jqXHR) {
            $.redirect("buat.php", {trx: 1, id: response, ismtr:1});
        });
        request.fail(function (jqXHR, textStatus, errorThrown) {
            alert(
                    "The following error occurred: " +
...
<script>
    ...
    $("#exists2").click(function (event) {
        ...
        request.done(function (response, textStatus, jqXHR) {
            $.redirect("buat.php", {trx: 1, id: response, ismtr:0});
        });
        request.fail(function (jqXHR, textStatus, errorThrown) {
            alert(
                    "The following error occurred: " +
