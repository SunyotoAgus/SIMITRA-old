    ...
    <div class="container">
        ...
        <form id="trxform">
            <div class="form-horizontal">
                ...
                <input type="hidden" name="ismitrabinaan" value="<?php echo $mtr ?>"/>
                <?php
                if (!empty($_POST['id'])) {
                ...
                ?>
                <div class="form-group">
                    <label class='control-label input-xs col-sm-4' for="nama">Kategori :</label>
                    <div class="col-sm-5">  
                        <select class="form-control my-no-hover input-xs" name='catid'>
                            <option value=''>Pilih Kategori</option>
                            <?php
                            include '../templates/initializedb.php';
                            $querycat = 'select * from trxkategory';
                            $rescat = mysqli_query($connection, $querycat);
                            while ($rowcat = $rescat->fetch_assoc()) {
                                echo "<option value='" . $rowcat['catid'] . "'>" . $rowcat['catnama'] . "</option>\n";
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label class='control-label input-xs col-sm-4' for="pinjaman">Jumlah Penarikan :</label>
                ...
                <div class="form-group">
                    <label class='control-label input-xs col-sm-4' for="buat">Dibuat :</label>
                    <div class="col-sm-5">   
                        <input required name='dibuat' type="text" class="form-control my-no-hover input-xs" id="buat" />
                    </div>
                </div>

                <div class="form-group">
                    <label class='control-label input-xs col-sm-4' for="cek">Diperiksa :</label>
                    <div class="col-sm-5">   
                        <input required name='dicek' type="text" class="form-control my-no-hover input-xs" id="cek" />
                    </div>
                </div>

                <div class="form-group">
                    <label class='control-label input-xs col-sm-4' for="agree">Setuju Dibayar :</label>
                    <div class="col-sm-5">   
                        <input required name='disetujui' type="text" class="form-control my-no-hover input-xs" id="agree" />
                    </div>
                </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                ...
                                                <form action="buat.php" method="POST">
                                                    ...
                                                    <input type="hidden" name="ismtr" value="<?php echo $mtr; ?>" />
...
<script>
    $("#trxcari").keyup(function () {
        $.get("forms/trxmitracari.php?q=" + $("#trxcari").val() + "&ismtr=<?php echo $mtr; ?>", function (data, status) {
