...
<html>
    ...
    <body style="background: url(asset/bg.png)">
                        ...
                        elseif(!empty($_POST['drop'])){
                            ...
                            <div class="col-sm-6 center-col">
                                ...
                                <div class="panel panel-default container">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-link dropdown-toggle" type="button" data-toggle="dropdown">2. Buat data transaksi.
        ...
        <script>
            ...
            $(document).ready(function () {
                $("#exists1").click(function () {
                    $.get("forms/transaksibaru.php?ismtr=1", function (data, status) {
                        $("#place").html(data);
                    });
                });
            });
            ...
            $(document).ready(function () {
                $("#exists2").click(function () {
                    $.get("forms/transaksibaru.php?ismtr=0", function (data, status) {
                        $("#place").html(data);
                    });
                });
            });
